 ...
 */
public class AnnotationSetSideTab extends ASideTab {

	private static final String TITLE = "Sets";
	public static final Integer HEIGHT = 35;
	private static final String HEIGHT_PX = HEIGHT + "px";
	
	public AnnotationSetSideTab(IApplication application, SidePanelsFacade facade) {
