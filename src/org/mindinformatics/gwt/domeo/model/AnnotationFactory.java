...
/**
 * This factory is supposed to be extended by plugins that are introducing new
 * annotation artifacts. The localId counter is static so that the counter is
 * shared across all the factories.
 * 
...
public class AnnotationFactory implements IInitializableComponent {
	...
	public static MOnlineImage cloneOnlineImage(String label, String xPath,
			String url) {
	...
	// SETS -----------------------------------------------------------------
	// -----------------------------------------------------------------------
	public static MBibliographicSet createBibliographicSet(
			ISoftware createdWith, IPerson editor, MGenericResource target,
	...
	public static MAnnotationSet createAnnotationSet(ISoftware createdWith,
			IPerson editor, MGenericResource target, String label,
			String description) {
	...
	public static MAnnotationSet createNewAnnotationSet(ISoftware createdWith,
			IPerson editor, MGenericResource target) {
		MAnnotationSet set = new MAnnotationSet();
		set.setLocalId(getLocalId());
		set.setUuid(getUuid());
		set.setIndividualUri(getUrn(set.getUuid()));
	...
	// public static MAnnotationSet cloneAnnotationSet(String individualUri,
	// String lineageUri,
	// Date createdOn, Date lastSavedOn, ISoftware createdWith, IAgent editor,
	...
	/**
	 * Annotation Set cloning used by unmarshallers. Tool and creator are not
	 * initialized as they are defined through lazy binding.
	 * 
	 * @param individualUri
	 *            The uri of the Annotation Set
	 * @param lineageUri
	 *            The lineage uri of the Annotation Set
	 * @param lastSavedOn
	 *            Last saved date (can be null when set is not yet saved)
	 * @param versionNumber
	 *            The version number (null if the set is not yet saved)
	 * @param previousVersion
	 *            The pointer to the previous Annotation Set version (if exists)
	 * @param target
	 *            The target of the annotation
	 * @param label
	 *            The label of the Annotation Set
	 * @param description
	 *            The description of the Annotation Set
	 * @return The unmarshalled Annotation Set.
	 */
	public static MAnnotationSet createAnnotationSet(String individualUri,
			String lineageUri, Date lastSavedOn, String versionNumber,
			String previousVersion, MGenericResource target, String label,
			String description) {
		MAnnotationSet set = new MAnnotationSet();
		set.setLocalId(getLocalId());
		set.setUuid("");
	...
	private static void createAnnotationReference(
			MAnnotationReference annotationReference, MAgent creator,
			ISoftware tool, MReference reference, MGenericResource target) {
		annotationReference.setLocalId(getLocalId());
		annotationReference.setUuid(getUuid());
		annotationReference.setIndividualUri(getUrn(annotationReference
				.getUuid()));
	...
	public static MAnnotationReference createCitation(MAgent creator,
			ISoftware tool, MReference reference, MGenericResource target) {
		MAnnotationReference ref = new MAnnotationReference();
		AnnotationFactory.createAnnotationReference(ref, creator, tool,
				reference, target);
		return ref;
	}

	public static MAnnotationReference cloneCitation(String individualUri,
			IAgent creator, ISoftware tool, Date createdOn,
			MReference reference, MSelector selector) {
	...
	public static MAnnotationCitationReference cloneReference(
			String individualUri, IAgent creator, ISoftware tool,
			Date createdOn, Integer referenceIndex, MReference reference,
		...
		// AnnotationFactory.createAnnotationReference(ref, creator, reference,
		// target);
	...
	public static MAnnotationCitationReference createReference(MAgent creator,
			ISoftware tool, Integer referenceIndex, MReference reference,
			MGenericResource target, MSelector referenceSelector) {
		MAnnotationCitationReference ref = new MAnnotationCitationReference();
		AnnotationFactory.createAnnotationReference(ref, creator, tool,
				reference, target);
		ref.setSelector(referenceSelector);
	...
	// -----------------------------------------------------------------------
	/**
	 * Used by the unmarshallers. The creator is initialized through lazy
	 * binding.
	 * 
	 * @param individualUri
	 *            The uri
	...
	public static MTextQuoteSelector clonePrefixSuffixTextSelector(
			String individualUri, Date createdOn, MGenericResource target,
			String exact, String prefix, String suffix) {
	...
	public static MAnnotationSelector createAnnotationSelector(IAgent creator,
			MGenericResource target, MAnnotation annotation) {
	...
	public static MAnnotationSelector cloneAnnotationSelector(
			String individualUri, Date createdOn, IAgent creator,
	...
	// HIGHLIGHTS -----------------------------------------------------------
	// -----------------------------------------------------------------------
	public static MHighlightAnnotation createHighlight(MAnnotationSet set,
			IAgent creator, ISoftware tool, MGenericResource target,
			MSelector selector) {
	...
	public static MHighlightAnnotation cloneHighlight(String individualUri,
			String lineageUri, Date createdOn, Date lastSavedOn,
	...
	// TEMPORARY ------------------------------------------------------------
	// -----------------------------------------------------------------------
	public static MSelectionAnnotation createTemporary(MAnnotationSet set,
			IAgent creator, MGenericResource target, MSelector selector) {
	...
	// POST ITS -----------------------------------------------------------
	// -----------------------------------------------------------------------
	public static MPostItAnnotation createPostIt(MAnnotationSet set,
			IAgent creator, ISoftware tool, MGenericResource target,
			MSelector selector, PostitType type, String body) {
	...
	public static MTargetSelector cloneTargetSelector(String individualUri,
			MGenericResource target) {
	...
	public static MPostItAnnotation createPostIt(MAnnotationSet set,
			IAgent creator, ISoftware tool, PostitType type, String body) {
		MPostItAnnotation ann = new MPostItAnnotation();
		ann.setLocalId(getLocalId());
		ann.setUuid(getUuid());
		ann.setIndividualUri(getUrn(ann.getUuid()));
	...
	public static MPostItAnnotation createPostIt(IDomeo domeo,
			MAnnotationSet set, IAgent creator, ISoftware tool,
			MGenericResource target, PostitType type, String body) {
		...
		selector.setUuid(getUuid());
		selector.setUri(getUrn(selector.getUuid()));
		selector.setContext(domeo.getAnnotationPersistenceManager()
				.getCurrentResource());
	...
	public static MPostItAnnotation clonePostIt(String individualUri,
			String lineageUri, Date createdOn, Date lastSavedOn,
			MAnnotationSet set, IAgent creator, ISoftware tool,
			String versionNumber, String previousVersion,
			MGenericResource target, ArrayList<MSelector> selectors,
	...
	// QUALIFIER ------------------------------------------------------------
	// -----------------------------------------------------------------------
	public static MQualifierAnnotation createQualifier(MAnnotationSet set,
			IAgent creator, ISoftware tool, MGenericResource target,
			MSelector selector, MLinkedResource term) {
	...
	public static MQualifierAnnotation createQualifier(IDomeo domeo,
			MAnnotationSet set, IAgent creator, ISoftware tool,
			MGenericResource target, MLinkedResource term) {
		MImageInDocumentSelector selector = new MImageInDocumentSelector();
		selector.setCreator(creator);
		selector.setCreatedOn(new Date());
		selector.setTarget(target);
	...
	public static MImageInDocumentSelector createImageSelector(IDomeo domeo,
	...
	public static MQualifierAnnotation createQualifier(IDomeo domeo,
		...
		MImageInDocumentSelector selector = createImageSelector(domeo, creator,
				target);
	...
	public static MQualifierAnnotation cloneQualifier(String individualUri,
			String lineageUri, Date createdOn, Date lastSavedOn,
			MAnnotationSet set, IAgent creator, String versionNumber,
			String previousVersion, MGenericResource target,
			ArrayList<MSelector> selectors, String label) {
		MQualifierAnnotation ann = new MQualifierAnnotation();
		ann.setLocalId(getLocalId());
		ann.setUuid("");
		ann.setLineageUri(lineageUri);
	...
	// COMMENTS ------------------------------------------------------------
	// -----------------------------------------------------------------------
	public static MCommentAnnotation cloneComment(String individualUri,
			String lineageUri, Date createdOn, Date lastSavedOn,
			String versionNumber, String previousVersion, MAnnotationSet set,
			IAgent creator, ISoftware tool, MGenericResource target,
			ArrayList<MSelector> selectors, String text) {
	...
	public static MCommentAnnotation createComment(MAnnotationSet set,
			IAgent creator, ISoftware tool, MGenericResource target,
			MSelector selector, String text) {
		MCommentAnnotation ann = new MCommentAnnotation();
		ann.setLocalId(getLocalId());
		ann.setUuid(getUuid());
		ann.setIndividualUri(getUrn(ann.getUuid()));
	...
	public static MCommentAnnotation createComment(MAnnotationSet set,
			IAgent creator, ISoftware tool, MGenericResource target, String text) {
		MCommentAnnotation ann = new MCommentAnnotation();
		ann.setLocalId(getLocalId());
		ann.setUuid(getUuid());
		ann.setIndividualUri(getUrn(ann.getUuid()));
	...
	// SPLs -----------------------------------------------------------
	// uses createContentAsRdf, createTargetSelector, cloneTargetSelector
	// defined above
	// -----------------------------------------------------------------------
	public static MSPLsAnnotation createSPLs(MAnnotationSet set,
			IAgent creator, ISoftware tool, MGenericResource target,
			MSelector selector, SPLType type, String body) {
	...
	public static MSPLsAnnotation createSPLs(MAnnotationSet set,
			IAgent creator, ISoftware tool, SPLType type, String body) {
		MSPLsAnnotation ann = new MSPLsAnnotation();
		ann.setLocalId(getLocalId());
		ann.setUuid(getUuid());
		ann.setIndividualUri(getUrn(ann.getUuid()));
	...
	public static MSPLsAnnotation createSPLs(IDomeo domeo, MAnnotationSet set,
			IAgent creator, ISoftware tool, MGenericResource target,
	...
	public static MSPLsAnnotation cloneSPLs(String individualUri,
			String lineageUri, Date createdOn, Date lastSavedOn,
			MAnnotationSet set, IAgent creator, ISoftware tool,
			String versionNumber, String previousVersion,
			MGenericResource target, ArrayList<MSelector> selectors,
		...
		// TODO: why not just create a constructor for the class? This step here
		// is needed or a null expection will trigger when data is added to the
		// annotation
