 ...
 */
public class SPL_DDIFactory extends AnnotationFactory {

    //  QUALIFIER ------------------------------------------------------------
    // -----------------------------------------------------------------------
    public static MSPL_DDIAnnotation createSPL_DDIAnnotation(IDomeo domeo,
	...
	MSPL_DDIAnnotation ann = new MSPL_DDIAnnotation();
    ...
    public static MSPL_DDIAnnotation createSPL_DDIAnnotation(
						       MAnnotationSet set, IAgent creator, ISoftware tool, 
