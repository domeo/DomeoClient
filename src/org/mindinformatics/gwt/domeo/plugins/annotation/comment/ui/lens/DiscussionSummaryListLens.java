 ...
 */
public class DiscussionSummaryListLens extends Composite implements ILensRefresh, ILensComponent {

	interface Binder extends UiBinder<Widget, DiscussionSummaryListLens> { }
	...
	public DiscussionSummaryListLens(IDomeo domeo, final CommentSidePanel parent, MAnnotationSet set, MCommentAnnotation comment) {
		_domeo = domeo;
		_this = this;
		_set = set;
		_comment = comment;
