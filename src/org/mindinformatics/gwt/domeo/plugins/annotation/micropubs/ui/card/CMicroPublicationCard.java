 ...
 */
public class CMicroPublicationCard extends ACardComponent {

	interface Binder extends UiBinder<Widget, CMicroPublicationCard> { }
	...
	public CMicroPublicationCard(IDomeo domeo) {
		super(domeo);
	...
	public void refresh() {
		try {
			...
			type.setText(_annotation.getMicroPublication().getType()+":");
