 ...
 */
public class StatementsSearchBar extends Composite {
	...
	// UI binder
	interface Binder extends UiBinder<HorizontalPanel, StatementsSearchBar> { }
	...
	public StatementsSearchBar(IDomeo domeo, StatementsSearchWidget searchWidget) {
		_domeo = domeo;
		...
		searchType.addItem("Local", "Local");
		searchType.addItem("Remote", "Remote");
	}
