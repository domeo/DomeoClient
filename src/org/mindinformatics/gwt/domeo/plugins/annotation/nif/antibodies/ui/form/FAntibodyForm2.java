 ...
 */
public class FAntibodyForm2 extends AFormComponent implements IResizable, IAntibodiesSearchContainer, IAntibodySelectionConsumer {
	...
	interface Binder extends UiBinder<ScrollPanel, FAntibodyForm2> { }
	...
	@UiField HTMLPanel header3;
	@UiField SimplePanel protocolTitleBar;
	@UiField SimplePanel subjectTitleBar;
	@UiField SimplePanel noteTitleBar;
	...
	public FAntibodyForm2(IDomeo domeo, final AFormsManager manager, boolean inFolders) {
		super(domeo);
		_manager = manager;
	...
	// ------------------------
	public FAntibodyForm2(IDomeo domeo, final AFormsManager manager, final MAntibodyAnnotation annotation) {
		super(domeo);
		_manager = manager;
		_item = annotation;
...
//	}
	...
	public void resized() {
		if(_manager.getContainerWidth()>0 && _manager.getContainerWidth()<1290) {
			...
			header3.setWidth(Math.max(464, (Window.getClientWidth() - 174)) + "px");
			protocolTitleBar.setWidth(Math.max(464, (Window.getClientWidth() - 174)) + "px");
			subjectTitleBar.setWidth(Math.max(464, (Window.getClientWidth() - 174)) + "px");
			...
			header3.setWidth("464px");
			protocolTitleBar.setWidth("460px");
			subjectTitleBar.setWidth("460px");
			noteTitleBar.setWidth("460px");
			...
			container.setWidth((Window.getClientWidth() - 360) + "px");
			
			
			tabBar.setWidth(Math.min(900, (Window.getClientWidth() - 616)) + "px");
			container.setCellWidth(leftColumnContainer, Math.min(900, (Window.getClientWidth() - 616)) + "px");
			for(Widget tab:tabs) {
				//if(tab instanceof IResizable) ((IResizable)tab).resized();
