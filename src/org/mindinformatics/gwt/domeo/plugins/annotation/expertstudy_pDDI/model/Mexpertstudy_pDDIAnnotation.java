...
public class Mexpertstudy_pDDIAnnotation extends MAnnotation implements
		Iexpertstudy_pDDI {
	// Plugin builder error
	private expertstudy_pDDIType type;
	public expertstudy_pDDIType getType() {
		return type;
	}

	public void setType(expertstudy_pDDIType type) {
		this.type = type;
	}
