 ...
 */
public class LLinearCommentsSetInfoLens extends Composite implements ILensRefresh, ILensComponent {

	public static final String DESCRIPTION_CAPTION = "<type description here>";
	
	interface Binder extends UiBinder<Widget, LLinearCommentsSetInfoLens> { }
	private static final Binder binder = GWT.create(Binder.class);
	
	private IDomeo _domeo;
	private MAnnotationSet _set;
	private LLinearCommentsSetInfoLens _this;
	...
	public LLinearCommentsSetInfoLens(IDomeo domeo, final LinearCommentsSidePanel parent) {
		_domeo = domeo;
		_parent = parent;
