...
public interface IBioPortalConnector {
	...
	public void textmine(ITextminingRequestCompleted completionCallback, final String url,
			final String textContent, final boolean longestOnly,
			 final boolean wholeWordOnly, final boolean filterNumbers,
			 final boolean withDefaultStopWords, final boolean isStopWordsCaseSenstive,
			 final boolean scored, final boolean withSynonyms);
}
