package org.mindinformatics.gwt.domeo.plugins.resource.ebi.service.annotator;
 ...
 */
public class FEbiAnnotatorParametrizationForm extends Composite {

	interface Binder extends UiBinder<Widget, FEbiAnnotatorParametrizationForm> { }
...
//	@UiField FlowPanel categories;
	...
	public FEbiAnnotatorParametrizationForm(IDomeo domeo) {
		_domeo = domeo;
...
//		wholeWordOnly.setValue(PEbiAnnotatorParameters.getInstance().wholeWordOnly);
//		wholeWordOnly.addClickHandler(new ClickHandler() {
//			@Override
//			public void onClick(ClickEvent event) {
//				PEbiAnnotatorParameters.getInstance().wholeWordOnly=wholeWordOnly.getValue();
//			}
//		});
//		
//		filterNumbers.setValue(PEbiAnnotatorParameters.getInstance().filterNumbers);
//		filterNumbers.addClickHandler(new ClickHandler() {
//			@Override
//			public void onClick(ClickEvent event) {
//				PEbiAnnotatorParameters.getInstance().filterNumbers=filterNumbers.getValue();
//			}
//		});
//		
//		withDefaultStopWords.setValue(PEbiAnnotatorParameters.getInstance().withDefaultStopWords);
//		withDefaultStopWords.addClickHandler(new ClickHandler() {
//			@Override
//			public void onClick(ClickEvent event) {
//				PEbiAnnotatorParameters.getInstance().withDefaultStopWords=withDefaultStopWords.getValue();
//			}
//		});
//		
//		isStopWordsCaseSenstive.setValue(PEbiAnnotatorParameters.getInstance().isStopWordsCaseSenstive);
//		isStopWordsCaseSenstive.addClickHandler(new ClickHandler() {
//			@Override
//			public void onClick(ClickEvent event) {
//				PEbiAnnotatorParameters.getInstance().isStopWordsCaseSenstive=isStopWordsCaseSenstive.getValue();
//			}
//		});
//		
//		scored.setValue(PEbiAnnotatorParameters.getInstance().scored);
//		scored.addClickHandler(new ClickHandler() {
//			@Override
//			public void onClick(ClickEvent event) {
//				PEbiAnnotatorParameters.getInstance().scored=scored.getValue();
//			}
//		});
//		
//		withSynonyms.setValue(PEbiAnnotatorParameters.getInstance().withSynonyms);
//		withSynonyms.addClickHandler(new ClickHandler() {
//			@Override
//			public void onClick(ClickEvent event) {
//				PEbiAnnotatorParameters.getInstance().withSynonyms=withSynonyms.getValue();
//			}
//		});
