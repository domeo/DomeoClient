 ...
 */
public class PubMedRetrieveBibliographyByUrlCommand extends APubMedBibliograhyExtractorCommand implements ICommand, IRetrieveExistingBibliographySetHandler {
	...
	public PubMedRetrieveBibliographyByUrlCommand(IDomeo domeo, ICommandCompleted completionCallback) {
		_domeo = domeo;		
