 ...
 */
public class GwtPubMedServiceConnector implements IPubMedConnector {
...
//	}
	...
	private MPublicationArticleReference getPublicationArticleReference(String typeQuery, String textQuery) {
		//Window.alert(typeQuery + " - " + textQuery);
		...
		} else if(typeQuery.equals(PubMedExtractSubjectCommand.PUBMED_CENTRAL_IDS) || typeQuery.equals(PubMedExtractSubjectCommand.PUBMED_CENTRAL_ID)) {
