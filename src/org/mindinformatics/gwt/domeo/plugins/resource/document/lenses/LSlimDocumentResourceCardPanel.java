 ...
 */
public class LSlimDocumentResourceCardPanel extends Composite implements IRefreshableComponent, 
	IResourceLensComponent, ICachedImages {
	
	public static final String KNOWN_RESOURCE = "KNOWN RESOURCE";
	
	interface Binder extends UiBinder<Widget, LSlimDocumentResourceCardPanel> { }
	...
	public LSlimDocumentResourceCardPanel(IDomeo domeo) {
		_domeo = domeo;
