 ...
 */
public class PubMedCentralRetrieveBibliographyByUrlCommand extends APubMedBibliograhyExtractorCommand implements ICommand, IRetrieveExistingBibliographySetHandler {
	...
	public PubMedCentralRetrieveBibliographyByUrlCommand(IDomeo domeo, ICommandCompleted completionCallback) {
		_domeo = domeo;		
	...
	@Override
	public void execute() {
		((ProgressMessagePanel)((DialogGlassPanel)_domeo.getDialogPanel()).getPanel()).setMessage("Retrieving existing...");
