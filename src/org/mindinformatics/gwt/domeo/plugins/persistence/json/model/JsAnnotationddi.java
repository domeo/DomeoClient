...
import org.mindinformatics.gwt.domeo.plugins.annotation.ddi.model.JsoDDI_SetsUsage;
...
public class JsAnnotationddi extends JavaScriptObject{
	protected JsAnnotationddi() {}
	...
	// ------------------------------------------------------------------------
	//  Assertion type and evidence modality
	// ------------------------------------------------------------------------
	
	public final native String getEvidenceType() /*-{
    	return this['dikbD2R:evidenceType'];
}-*/;
	
	public final native String getAssertionType() /*-{
    	return this['dikbD2R:assertionType'];
}-*/;
	...
	public final native String getType() /*-{ return this.domeo_ddiType; }-*/;
}
