 ...
 * under the License.
 */
package org.mindinformatics.gwt.domeo.plugins.persistence.annotopia.ui.existingsets;
...
public class AnnotationSetTreeViewModel implements TreeViewModel {
	...
	private ExistingAnnotationViewerPanel parent;
	...
	public AnnotationSetTreeViewModel(final SelectionModel<AnnotationSetInfo> selectionModel, final ExistingAnnotationViewerPanel parent) {
		this.parent = parent;
	...
	public static class AnnotationSetInfo implements Comparable<AnnotationSetInfo> {
		...
		private MAnnotopiaAnnotationSet annotationSet;

		public AnnotationSetInfo(Category category, MAnnotopiaAnnotationSet annotationSet) {
		...
		public int compareTo(AnnotationSetInfo o) {
			return (o == null || o.annotationSet.getLastSavedOn() == null) ? -1 : -o.annotationSet.getLastSavedOn()
					.compareTo(annotationSet.getLastSavedOn());
		}
		...
		public Date getLastSavedOn() {
			return annotationSet.getLastSavedOn();
		}
...
//		}
		...
		public MAnnotopiaAnnotationSet getAnnotationSet() {
	...
	public static class AnnotationSetCell extends
		...
		ExistingAnnotationViewerPanel parentPanel;
		...
		public AnnotationSetCell(SelectionModel<AnnotationSetInfo> selectionModel, ExistingAnnotationViewerPanel parentPanel) {
			super("mousedown");
