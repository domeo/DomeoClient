...
public class ResourcesFactory {
	 ...
	 * Throws a RuntimeException if the url is not valid.
	 ...
	 * @param url	The URI of the resource
	 * @param label The label for human consumption
	 * @param description	The description for human consumption
	 * @return The Linked Resource
	 */
	 ...
	 * @return The Trusted Resource (a Generic Resource with specified source)
	 */
	public static MTrustedResource createTrustedResource(String url, String label, String description, MGenericResource source) {
		MTrustedResource trustedResource = createTrustedResource(url, label, source);
	 ...
	 * @return Trusted Typed Resource (a Trusted Resource with types)
	 */
	public static MTrustedTypedResource createTrustedTypedResource(String url, String label, String description, String type, MGenericResource source) {
	 ...
	 * @return Trusted Typed Resource (a Trusted Resource with types)
	 */
	public static MTrustedTypedResource createTrustedTypedResource(String url, String label, String description, String type, String sourceUrl, String sourceLabel) {
		MTrustedTypedResource r = createTrustedTypedResource(url, label, createGenericResource(sourceUrl, sourceLabel));
		r.setDescription(description);
		r.addTypeUri(type);
		return r;
	}
