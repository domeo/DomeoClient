...
public class Utils {
	...
	public static final String SPACE = " ", SLASH = "/", POST = "post", PUT = "put", GET = "get", DELETE = "delete", JSON = "json", AUTHORIZATION = "Authorization";
...
//	}-*/;
	...
	public static Properties getAnnotopiaOAuthToken() {
		return (Utils.getAnnotopiaOauthEnabled().equalsIgnoreCase("true")? Properties.create("Authorization: Bearer " + Utils.getAnnotopiaOauthToken()): Properties.create());
	}
