		...
		if(pathInfo.indexOf("/")==0 && pathInfo.lastIndexOf("/")>0 && pathInfo.length()>pathInfo.lastIndexOf("/")+1) {
			...
			if(format.equals("json") && username.equals("paolo.ciccarese")) {
				if(request.equals("info")) {
					...
					out.print("[{\"uri\":\"urn:user:uuid:admin\",\"username\":\"admin\",\"screenname\":\"Dr. John Doe\"}]");
//					out.println('[');
//		
//					out.println("  {");
//					out.print("    \"uri\": \"");
...
//					out.println(']');
					...
					PrintWriter out = resp.getWriter();
					out.print("[{\"uuid\":\"8a70347a4096d318014096d369cf0005\",\"uri\":\"urn:group:uuid:8a70347a4096d318014096d369cf0005\",\"name\":\"Test Group 1\",\"description\": \"Test Group 1\",\"memberssince\":\"2013-08-19 09:46:12.0\",\"grouplink\":\"http://localhost:8080/Domeo/group/?uri=urn:group:uuid:8a70347a4096d318014096d369cf0005\",\"roles\":[{\"uuid\":\"GROUP_ADMIN\",\"name\":\"Admin\"}],\"visibility\":[{\"uuid\":\"org.mindinformatics.domeo.uris.visibility.Public\",\"name\":\"Public\"}],\"permissionread\":\"true\",\"permissionwrite\":\"true\"}]");
//					out.println('[');
//					// TODO groups
//					out.println("  {");
//					out.print("    \"uuid\": \"");
